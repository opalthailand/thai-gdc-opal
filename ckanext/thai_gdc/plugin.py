...
from ckanext.thai_gdc import blueprint
...
class Thai_GDCPlugin(plugins.SingletonPlugin, DefaultTranslation, toolkit.DefaultDatasetForm):
    ...
    def get_blueprint(self):
        return blueprint.thai_gdc_blueprint
    ...
    def dataset_facets(self, facets_dict, package_type):
        ...
        facets_dict['data_classification'] = toolkit._('Data Classification') #ระดับชั้นข้อมูล
    ...
    def update_config(self, config_):
        toolkit.add_ckan_admin_tab(config_, 'thai_gdc.edit_banner', u'แก้ไขแบนเนอร์', icon='wrench')
        toolkit.add_ckan_admin_tab(config_, 'thai_gdc.import_dataset', u'นำเข้ารายการชุดข้อมูล', icon='cloud-upload')
        toolkit.add_ckan_admin_tab(config_, 'thai_gdc.export_dataset_init', u'ส่งออกรายการชุดข้อมูล', icon='cloud-download')
        toolkit.add_ckan_admin_tab(config_, 'thai_gdc.edit_popup', u'ป็อปอัพ', icon='window-maximize')
        ...
        config_['thai_gdc.catalog_org_type'] = config_.get('thai_gdc.catalog_org_type','agency') #agency/area_based/data_center/local_government
